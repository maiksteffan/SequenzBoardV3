 ...
 */
 ...
 #define LV_USE_FREETYPE 0
     ...
     #define LV_FREETYPE_CACHE_SIZE (16 * 1024)
         ...
         /* 0: no caching, 1: light caching, 2: full caching
         * light: not cache all the bitmap always (fast but font like 20, 21... are not set correctly),
         * full: cache all the bitmap (slow but all the bitmap are set correctly, the less error) */
         #define LV_FREETYPE_CACHE_MODE 1
     #endif
 #endif
 ...
 *==================*/
 ...
 /*Use RGB565A8 images with alpha channel*/
